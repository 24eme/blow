    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"><a class="nav-link" href="#objectif">Notre objectif</a></li>
        ...
        @if (Route::has('register'))
            <li class="nav-item">
                <a class="btn btn-dark" href="{{ route('register') }}">{{ __('S\'inscrire') }}</a>
            </li>
        @endif
  </nav>
@else
  <nav class="navbar navbar-expand-lg navbar-light home-navbar">
   <div class="container-fluid">
     <div class="navbar-header">
       <a class="navbar-brand nav-link" href="#!">BL<u>O</u>W<img style="width:30px;height:30px;" src="/favicon.png"></a>
     </div>
