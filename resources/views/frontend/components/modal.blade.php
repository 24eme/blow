...
<div class="modal fade" id="update-modal" tabindex="-1" role="dialog" aria-labelledby="Reservation" aria-hidden="true">
    <div class="modal-dialog " role="document">
      <div class="modal-content">
        <div class="modal-header">
          <div class="header-box"><h5 class="modal-title">Réserver votre salle</h5>
        ...
        <div class="modal-body">
          <form method="POST" action="{{url('/updateEvent/{id}')}}">
            <input type="text" id="title" name="title" placeholder="Nom de l'événement" value=""><br></br>
      <!-- A faire droit de réserver que 3h de suite-->
            <input name="resourceId" id="resourceId" style="display:none">
            <label>Début : </label>
            <input type="date" id="start" name="datededebut" value="2020-06-09T09:30:00Z"><input type="time" id="startTime" name="startTime" min="06:00" max="20:00" required><br>
            <hr>
            <label>Fin : </label><input type="date" id="end" name="end" value=""><input type="time" id="endTime" name="endTime" min="06:00" max="20:00" required><br>
            <hr>
            <input type="checkbox" name="rappel">
            <label>Planifier un rappel
              <select>
